      ...
      >
        ...
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-xl">
          ...
          <button 
            ...
            disabled={loading}
            className="flex w-full mt-4 items-center justify-center gap-3 rounded-lg border border-white/5 bg-white/5 py-2.5 text-sm font-medium text-white hover:bg-white/10 transition-all"
          >
